...
def test_scenario_2_shared_onion_contribution():
    """Test scenario where agent 0 puts 2 onions, agent 1 puts 1 onion with GIF recording"""
    ...
    for reward_setting in ['default', 'sparse', 'individual']:
        print(f"\n{reward_setting.capitalize()} rewards for Agent 0: 2 onions + plate + deliver, Agent 1: 1 onion...")
    ...
    print("✅ Shared onion contribution: All reward settings work correctly")

    return results


if __name__ == "__main__":
    test_scenario_2_shared_onion_contribution()
