...
def rotate_fn(fin, cx, cy, theta):
    """
    Rotate a function around a point
    """
    def fout(x, y):
        x = x - cx
        y = y - cy
...
def point_in_line(x0, y0, x1, y1, r):
    """
    Create a function that checks if a point is within a distance r of a line
    """
...
def point_in_circle(cx, cy, r):
    """
    Create a function that checks if a point is within a circle
    """
    def fn(x, y):
