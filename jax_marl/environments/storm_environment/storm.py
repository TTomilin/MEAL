...
from jax_marl.environments.multi_agent_env import MultiAgentEnv
from jax_marl.environments import spaces


from jax_marl.environments.storm_environment.rendering import (
    downsample,
    fill_coords,
    highlight_img,
    point_in_circle,
...
def generate_agent_colors(num_agents):
    '''
    generates a list of RGB tuples for each agent in the environment based on the number of agents.
    '''
    colors = []
