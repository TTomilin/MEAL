...
def main():
    ...
    evaluate_env = make_eval_fn(cl, reset_switch, step_switch, actor, agents, seq_length, cfg.num_steps, cfg.use_cnn)
                ...
                def log_metrics(metrics, update_step):
                    if cfg.evaluation:
                        avg_rewards, avg_soups = evaluate_all_envs(
                            cl_state, eval_rng, actor_train_state.params, seq_length, evaluate_env
                        )
