from .grid_map import GridMapCircleAgents, GridMapPolygonAgents, GridMapBarn, GridMapPolygonAgentsSingleMap, \
    GridMapFromBuffer


def make_map(map_id: str, num_agents: int, rad: float,
             **map_kwargs) -> GridMapCircleAgents:  # note this type hint technically should be Map
