...
from meal.env.overcooked.layouts.presets import overcooked_layouts as layouts
...
class Overcooked(MultiAgentEnv):
    ...
    def __init__(
        ...
        # If a layout is provided (custom or preset), trust its dimensions.
        # Otherwise (auto-generated by difficulty), use difficulty params.
        if layout is not None or layout_name is not None:
    ...
    def get_obs(self, state: State) -> Dict[str, chex.Array]:
        ...
        onions_in_soup_with_inv = onions_in_soup + (
                jnp.sum(agent_inv_items, 0) == OBJECT_TO_INDEX["dish"]) * state.max_onions_in_pot * jnp.sum(pos_layers,
                                                                                                            0)
    ...
    def reset(
        ...
        agent_pos = jnp.array([agent_idx % width, agent_idx // width],
