...
def create_heuristic_policy(
    ...
    """
    Args:
        env: the SMAX environment to operate in
        team (int): 0 for allies, 1 for enemies
        shoot (bool): Whether or not the agents should shoot. Defaults to True.
        attack_mode (str): How the agents should choose targets.
