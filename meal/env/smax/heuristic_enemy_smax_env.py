import dataclasses
from meal.env.smax.smax_env import SMAX
from meal.env.smax.smax_env import State as SMAXState
from meal.env.smax.heuristic_enemy import (
...
class State:
    ...
    state: ...
    # enemy policy state (for heuristic or recurrent policies)
    enemy_policy_state: ...


class EnemySMAX(MultiAgentEnv):
    """Presents SMAX as a single-team environment. Ally agents train; enemies
    use a pluggable policy (heuristic or learned)."""
