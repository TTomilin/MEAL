...
def run_training():
    ...
    max_soup_dict = {layout_name: estimate_max_soup(
        config.layout["layout"], env.max_steps, n_agents=env.num_agents)}
    ...
    if config.alg == "br":
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            ...
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=0, max_steps=config.gif_len)
            partner_name = "BRDiv_Partner_0"
            visualizer.animate(states, agent_view_size=5, task_idx=0,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            ...
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=1, max_steps=config.gif_len)
            partner_name = "BRDiv_Partner_1"
            visualizer.animate(states, agent_view_size=5, task_idx=1,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            temp_train_state = TrainState.create(
                apply_fn=ego_policy.network.apply, params=ego_params, tx=optax.adam(1e-4))
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=2, max_steps=config.gif_len)
            partner_name = "BRDiv_Partner_2"
            visualizer.animate(states, agent_view_size=5, task_idx=2,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            temp_train_state = TrainState.create(
                apply_fn=ego_policy.network.apply, params=ego_params, tx=optax.adam(1e-4))
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=3, max_steps=config.gif_len)
            partner_name = "Independent_Policy"
            visualizer.animate(states, agent_view_size=5, task_idx=3,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            temp_train_state = TrainState.create(
                apply_fn=ego_policy.network.apply, params=ego_params, tx=optax.adam(1e-4))
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=4, max_steps=config.gif_len)
            partner_name = "Onion_Policy"
            visualizer.animate(states, agent_view_size=5, task_idx=4,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            temp_train_state = TrainState.create(
                apply_fn=ego_policy.network.apply, params=ego_params, tx=optax.adam(1e-4))
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=5, max_steps=config.gif_len)
            partner_name = "Plate_Policy"
            visualizer.animate(states, agent_view_size=5, task_idx=5,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            temp_train_state = TrainState.create(
                apply_fn=ego_policy.network.apply, params=ego_params, tx=optax.adam(1e-4))
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=6, max_steps=config.gif_len)
            partner_name = "Random_Policy"
            visualizer.animate(states, agent_view_size=5, task_idx=6,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
        ...
        if hasattr(config, 'record_gif') and config.record_gif:
            temp_train_state = TrainState.create(
                apply_fn=ego_policy.network.apply, params=ego_params, tx=optax.adam(1e-4))
            states = record_gif_of_episode(
                config, temp_train_state, env, ego_policy.network, env_idx=7, max_steps=config.gif_len)
            partner_name = "Static_Policy"
            visualizer.animate(states, agent_view_size=5, task_idx=7,
                               task_name=partner_name, exp_dir=f"gifs/{run.name}")
    else:
